  ...
  async handleCallback(request: Request): Promise<Response> {
    ...
    try {
      ...
      if (callbackMatch) {
        ...
        callbackUrl.searchParams.set('workspaceId', workspaceInfo.organization.id)
        callbackUrl.searchParams.set('workspaceName', workspaceInfo.organization.name)
      ...
      cyrusUrl.searchParams.set('workspaceName', workspaceInfo.organization.name)
