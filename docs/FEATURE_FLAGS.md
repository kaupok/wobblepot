...
- **Short-circuit before any expensive work.** When wiring a kill-switch into a route, put the flag check _before_ any DB query, AI call, or external fetch. The whole point is to skip them.
