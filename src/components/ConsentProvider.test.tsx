...
// The provider renders CookieBanner, whose `t.rich` (privacy-policy link)
// returns React elements — the default vitest next-intl mock (a plain
// string-resolver) cannot handle it. Use the real provider.
vi.unmock('next-intl')
