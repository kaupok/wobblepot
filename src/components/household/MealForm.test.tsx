...
/**
 * The form's title is the page title (`variant="h4" as="h1"`, HON-779); its
 * sections sit one level below it in both the type scale and the document
 * outline. See HON-613.
 *
 ...
 * increases greater than one, so a section that drifts back to `as="h5"` or
 * forgets `as` altogether would still read to axe as a legal outline.
 */
